...
namespace Tarea.Business.Entidades
{
    public class Doctores : Persona, IEntity
    {
        ...
        //debe ser menor o igual a 16, ser puros numeros y no tener espacios en blanco
        public string Cedula 
        { 
            get => _cedula; 
            set => _cedula = value.IsNumber(nameof(Cedula)).LowerThan(17,nameof(Cedula)).HasWhiteSpace(nameof(Cedula)); 
        }
        //debe ser numero, tener 10 digitos y no tener espacios en blanco
